		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comsapktfragmfragmentpptexample-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsapktfragmfragmentpptexample-display": {
								"semanticObject": "comsapktfragmfragmentpptexample",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sap.kt.fragm.fragmentpptexample",
									"url": sap.ui.require.toUrl("com/sap/kt/fragm/fragmentpptexample")
								}
							}
						}
					}
